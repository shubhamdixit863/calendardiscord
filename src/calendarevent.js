...
class CalendarEvent {
    ...
    addEvent(summary, description, start_date, end_date,timezone,attachmentUrl,cb){
        ...
        this.calendar.events.insert({
            ...
            let eventLink=`https://calendar.google.com/calendar/r/eventedit?text=${summary.replace(/\s+/g, "")}&details=${description.replace(/\s+/g, "")}&dates=${startDateCombined}/${endDateCombined}&ctz=UTC&location=${event["data"].location}`
            cb(err,eventLink);
        });
    }
}
